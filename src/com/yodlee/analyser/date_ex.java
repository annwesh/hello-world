...
public class date_ex  extends BarRenderer{
...
class UniqueComparable implements Comparable<Object>{
    String c;
    UniqueComparable(String c){
        this.c = c;
    }
    ...
    public int compareTo(Object o){
    	UniqueComparable temp=(UniqueComparable)o;
       if(c.equals(temp.c))
    	return 0;
       else return 1;
    }
...
class CustomToolTipGenerator implements CategoryToolTipGenerator  {
	String trace;
	CustomToolTipGenerator(String str){
		this.trace=str;
	}
